...
- 외곽선/스트로크 금지 (컷아웃 스타일)
- 이모지 금지
- **실사 이미지 원칙 금지 — 단, 실물 유물은 예외**(2026-07-15, EP.6). 컷아웃으로 그린 족자·액자
  **안에** 넣으면 "실사를 쓴 것"이 아니라 "유물을 꺼내 보여주는 것"이 되어 세계관이 안 깨진다.
  맨몸으로 화면에 꽂는 건 여전히 금지. 예: EP.6 s6 김홍도 「공원춘효도」(`assets/`)
